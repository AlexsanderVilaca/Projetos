...
namespace _20201021___Isoplan_Cálculos
{
    static class Calculos
    {
        ...
        {
            double taxa;
            double[] lista = new double[28] { 13.97, 4.53, 3.31, 2.87, 2.65, 2.52, 2.43, 2.37, 2.32, 2.28, 2.25, 2.23, 2.21, 2.20, 2.18, 2.17, 2.16, 2.15, 2.14, 2.13, 2.11, 2.09, 2.07, 2.06, 2.06, 2.05, 2.025, 2 };
